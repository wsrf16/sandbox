...
import com.aio.portable.swiss.suite.security.authentication.shiro.cache.HashMapCacheManager;
import com.aio.portable.swiss.suite.security.authentication.shiro.filter.HamletBearerAuthenticationFilter;
...
//        filterChainDefinitionMap.put("/user/updateRequirePermissions", "jwt, perms");
    ...
    public FilterRegistrationBean delegatingFilterProxy(){
        FilterRegistrationBean filterRegistrationBean = new FilterRegistrationBean(bearerAuthFilter);
...
//    @Bean
//    public FilterRegistrationBean registration(HamletBearerAuthenticationFilter filter) {
